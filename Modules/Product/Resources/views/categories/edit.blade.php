...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item"><a href="{{ route('product-categories.index') }}">Ketegori</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('product-categories.update', $category->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-success">Perbarui <i class="bi bi-check"></i></button>
                            </div>
                        </form>
                    </div>
                </div>
