                                    ...
                                    <div class="from-group">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="payment_method" id="payment_method" required>
                                                <option {{ $purchaseReturnPayment->payment_method == 'Tunai' ? 'selected' : '' }} value="Tunai">Tunai</option>
                                                <option {{ $purchaseReturnPayment->payment_method == 'Kartu Kredit' ? 'selected' : '' }} value="Kartu Kredit">Kartu Kredit</option>
                                                <option {{ $purchaseReturnPayment->payment_method == 'Transfer Bank' ? 'selected' : '' }} value="Transfer Bank">Transfer Bank</option>
                                                <option {{ $purchaseReturnPayment->payment_method == 'Cek' ? 'selected' : '' }} value="Cek">Cek</option>
