                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status" required>
                                            <option {{ $purchase_return->status == 'Ditunda' ? 'selected' : '' }} value="Ditunda">Ditunda</option>
                                            <option {{ $purchase_return->status == 'Shipped' ? 'selected' : '' }} value="Shipped">Shipped</option>
                                            <option {{ $purchase_return->status == 'Selesai' ? 'selected' : '' }} value="Selesai">Selesai</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4">
