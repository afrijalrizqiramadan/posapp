...
@section('title', 'Edit Pengembalian Pembayaran')
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status" required>
                                            <option {{ $purchase_return->status == 'Ditunda' ? 'selected' : '' }}
                                                value="Ditunda">Ditunda</option>
                                            <option {{ $purchase_return->status == 'Pengiriman' ? 'selected' : '' }}
                                                value="Pengiriman">Pengiriman</option>
                                            <option {{ $purchase_return->status == 'Selesai' ? 'selected' : '' }}
