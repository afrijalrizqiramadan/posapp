                                    ...
                                    <div class="from-group">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="payment_method" id="payment_method" required>
                                                <option {{ $salePayment->payment_method == 'Tunai' ? 'selected' : '' }} value="Tunai">Tunai</option>
                                                <option {{ $salePayment->payment_method == 'Kartu Kredit' ? 'selected' : '' }} value="Kartu Kredit">Kartu Kredit</option>
                                                <option {{ $salePayment->payment_method == 'Transfer Bank' ? 'selected' : '' }} value="Transfer Bank">Transfer Bank</option>
                                                <option {{ $salePayment->payment_method == 'Cek' ? 'selected' : '' }} value="Cek">Cek</option>
