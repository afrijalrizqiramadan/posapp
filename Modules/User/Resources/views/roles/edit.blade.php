            ...
            <div class="col-md-12">
                ...
                <form action="{{ route('roles.update', $role->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-success">Update Role <i class="bi bi-check"></i>
                        </button>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="name">Peran Name <span class="text-danger">*</span></label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="show_weekly_sales_purchases">Weekly Sales & Pembelian</label>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="show_monthly_cashflow">Monthly Tunaiflow</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
