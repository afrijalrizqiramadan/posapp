                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status" required>
                                            <option {{ $sale_return->status == 'Ditunda' ? 'selected' : '' }}
                                                value="Ditunda">Ditunda</option>
                                            <option {{ $sale_return->status == 'Pengiriman' ? 'selected' : '' }}
                                                value="Pengiriman">Pengiriman</option>
                                            <option {{ $sale_return->status == 'Selesai' ? 'selected' : '' }}
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input id="paid_amount" type="text" class="form-control" name="paid_amount"
                                            required value="{{ $sale_return->paid_amount }}" readonly>
                                    </div>
                                </div>
                            </div>
