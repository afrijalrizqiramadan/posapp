                                    ...
                                    <div class="from-group">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="payment_method" id="payment_method" required>
                                                <option {{ $purchasePayment->payment_method == 'Tunai' ? 'selected' : '' }} value="Tunai">Tunai</option>
                                                <option {{ $purchasePayment->payment_method == 'Kartu Kredit' ? 'selected' : '' }} value="Kartu Kredit">Kartu Kredit</option>
                                                <option {{ $purchasePayment->payment_method == 'Transfer Bank' ? 'selected' : '' }} value="Transfer Bank">Transfer Bank</option>
                                                <option {{ $purchasePayment->payment_method == 'Cek' ? 'selected' : '' }} value="Cek">Cek</option>
                                                <option {{ $purchasePayment->payment_method == 'Other' ? 'selected' : '' }} value="Other">Lainnya</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
