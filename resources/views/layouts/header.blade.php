...
<ul class="c-header-nav ml-auto mr-4">
    ...
    <li class="c-header-nav-item mr-3">
        <a class="btn btn-success btn-pill {{ request()->routeIs('app.pos.index') ? 'disabled' : '' }}" href="{{ route('app.pos.index') }}">
        ...
        <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg pt-0">
            ...
            @forelse($low_quantity_products as $product)
                <a class="dropdown-item" href="{{ route('products.show', $product->id) }}">
                    <i class="bi bi-hash mr-1 text-primary"></i> Produk: "{{ $product->product_code }}" is low in quantity!
                </a>
            @empty
        ...
        <a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button"
           aria-haspopup="true" aria-expanded="false">
            <div class="c-avatar mr-2">
                <img class="c-avatar rounded-circle" src="{{asset('images/users/user-dummy-img.jpg')}}" alt="Profile Image">
            </div>
